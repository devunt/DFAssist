...
- Neueste Version ```v20190722.1``` ([Download](https://github.com/jaehyuk-lee/DFAssist/releases/latest))
...
![FFXIV-Icon blinkt](https://i.imgur.com/ndNAFZ8.gif)
...
![Anwendungsinterface 1](https://i.imgur.com/K9l6bLJ.png)  
![Anwendungsinterface 2](https://i.imgur.com/Sxno31F.png)  
![Anwendungsinterface 3](https://i.imgur.com/eBe0lRz.png)

### Taskleisten-Symbol

![Taskleisten-Symbol](https://i.imgur.com/zecDrdh.jpg)
